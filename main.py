from flask import Flask,jsonify #importing the flask module
import sqlalchemy
...
def home(): #page we want on our website
    f = open("index.html")
    text = f.read()
    f.close()
    return text
#returns the op to be displayed on the web page
...
@app.route("/<name>")
def user(name): #function definition
